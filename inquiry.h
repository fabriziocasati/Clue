...
{
public:
    Inquiry(int turn, std::string inquirer, std::string giver, std::string room, std::string suspect, std::string weaopon);
    int turn;
private:
    ...
    std::string weaopon;    //the weapon that is called by the inquirer player
};
