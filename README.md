...
*Clue Solver* does not allow to directly play Clue on the computer (the players still need the board game to play): it only provides reasoning support to the user.
